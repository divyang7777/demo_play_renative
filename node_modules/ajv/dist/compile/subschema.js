...
function extendSubschemaData(subschema, it, { dataProp, dataPropType: dpType, data, dataTypes, propertyName }) {
    ...
    if (dataProp !== undefined) {
        ...
        const nextData = gen.var("data", codegen_1._ `${it.data}${codegen_1.getProperty(dataProp)}`); // TODO var
    ...
    if (data !== undefined) {
        const nextData = data instanceof codegen_1.Name ? data : gen.var("data", data); // TODO var, replaceable if used once?
        dataContextProps(nextData);
