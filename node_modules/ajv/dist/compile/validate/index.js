...
function validateFunction({ gen, validateName, schema, schemaEnv, opts }, body) {
    gen.return(() => opts.code.es5
        ...
        : gen.func(validateName, codegen_1._ `${names_1.default.data}, {${names_1.default.dataPath}="", ${names_1.default.parentData}, ${names_1.default.parentDataProperty}, ${names_1.default.rootData}=${names_1.default.data}}={}`, schemaEnv.$async, () => gen.code(codegen_1._ `${funcSourceUrl(schema, opts)}`).code(body)));
}
