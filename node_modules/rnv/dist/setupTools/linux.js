...
var _constants=require("../constants");function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function(){var Super=(0,_getPrototypeOf2.default)(Derived),result;if(hasNativeReflectConstruct){var NewTarget=(0,_getPrototypeOf2.default)(this).constructor;result=Reflect.construct(Super,arguments,NewTarget);}else{result=Super.apply(this,arguments);}return(0,_possibleConstructorReturn2.default)(this,result);};}function _isNativeReflectConstruct(){if(typeof Reflect==="undefined"||!Reflect.construct)return false;if(Reflect.construct.sham)return false;if(typeof Proxy==="function")return true;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return true;}catch(e){return false;}}var
...
_shelljs.default.exec("apt-get -qq update && apt-get install "+
software+" -y > /dev/null"));case 3:return _context.abrupt("return",



true);case 4:case"end":return _context.stop();}}},null,null,null,Promise);}},{key:"installPrereqs",value:function installPrereqs(){return _regenerator.default.async(function installPrereqs$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(



this.availableDownloader){_context2.next=5;break;}
(0,_logger.logInfo)(
"Looks like you don't have wget or curl installed. We'll install wget for you");_context2.next=4;return _regenerator.default.awrap(
...
(0,_logger.logInfo)(
"Looks like you don't have unzip installed. We'll install it for you");_context2.next=9;return _regenerator.default.awrap(
...
(0,_logger.logInfo)(
"Looks like you don't have java installed. We'll install it for you");_context2.next=13;return _regenerator.default.awrap(

this.installSoftware('openjdk-8-jdk'));case 13:return _context2.abrupt("return",


true);case 14:case"end":return _context2.stop();}}},null,this,null,Promise);}},{key:"postInstall",value:function postInstall(
...
this.globalConfigPath+" with "+JSON.stringify({
androidSdk:location}));_context3.next=5;return _regenerator.default.awrap(


(0,_fileutils.updateConfigFile)(
{androidSdk:location},
this.globalConfigPath));case 5:


this.c.files.workspace.config.sdks.ANDROID_SDK=location;

ANDROID_SDK=
this.c.files.workspace.config.sdks.ANDROID_SDK;
this.c.cli[_constants.CLI_ANDROID_EMULATOR]=(0,_fileutils.getRealPath)(
this.c,
_path.default.join(ANDROID_SDK,'emulator/emulator'));

this.c.cli[_constants.CLI_ANDROID_ADB]=(0,_fileutils.getRealPath)(
this.c,
_path.default.join(ANDROID_SDK,'platform-tools/adb'));

this.c.cli[_constants.CLI_ANDROID_AVDMANAGER]=(0,_fileutils.getRealPath)(
this.c,
_path.default.join(ANDROID_SDK,'tools/bin/avdmanager'));

this.c.cli[_constants.CLI_ANDROID_SDKMANAGER]=(0,_fileutils.getRealPath)(
this.c,
_path.default.join(ANDROID_SDK,'tools/bin/sdkmanager'));case 11:case"end":return _context3.stop();}}},null,this,null,Promise);}}]);return LinuxPlatformSetup;}(_base.default);var _default=
