...
post(
_constants.REDASH_URL,_objectSpread(_objectSpread({},
e),defaultProps),
{
headers:{
...
integrations:[
new _integrations.RewriteFrames({
root:'/',
iteratee:function iteratee(frame){
if(
frame.filename.includes("rnv"+
_path.default.sep+"dist"+_path.default.sep)||

frame.filename.includes("rnv"+
_path.default.sep+"src"+_path.default.sep))
...
{
frame.filename=frame.filename.split("rnv"+
_path.default.sep+"dist"+_path.default.sep)[
1];
}else{
frame.filename=frame.filename.split("rnv"+
...
_this.errorFixer.captureException(
...
true);case 3:case"end":return _context.stop();}}},null,this,null,Promise);}},{key:"teardown",value:function teardown()
