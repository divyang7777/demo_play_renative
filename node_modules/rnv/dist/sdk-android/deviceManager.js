...
(0,_logger.logTask)('composeDevicesString',"numDevices:"+(devices?devices.length:null));
var devicesArray=[];
...
var launchAndroidSimulator=function launchAndroidSimulator(c,target){var isIndependentThread,newTarget,device,list,devicesString,choices,response,actualTarget,_args=arguments;return _regenerator.default.async(function launchAndroidSimulator$(_context){while(1){switch(_context.prev=_context.next){case 0:isIndependentThread=_args.length>2&&_args[2]!==undefined?_args[2]:false;
(0,_logger.logTask)(
...
var deviceString=(0,_logger.chalk)().white(
name)+" | "+
deviceIcon+" | arch: "+arch+" | udid: "+(0,_logger.chalk)().grey(udid)+(
isDevice?(0,_logger.chalk)().red(' (device)'):'')+" "+(
isActive?(0,_logger.chalk)().magenta(' (active)'):'');
...
(0,_logger.logTask)(
'getAndroidTargets',"skipDevices:"+
!!skipDevices+" skipAvds:"+!!skipAvds+" deviceOnly:"+!!deviceOnly);_context4.prev=2;if(
...
_constants.USER_HOME_DIR+"/.android/avd"];
...
var filesPath=(0,_fileutils.fsReaddirSync)(cPath);

filesPath.forEach(function(fName){
var fPath=_path.default.join(cPath,fName);
var dirent=(0,_fileutils.fsLstatSync)(fPath);
if(!dirent.isDirectory()&&fName===deviceName+".ini"){
var avdData=(0,_fileutils.fsReadFileSync)(fPath).toString();
...
if(key==='path'){
var initData=(0,_fileutils.fsReadFileSync)(value+"/config.ini").
toString();
...
name:'confirm',
type:'confirm',
message:"Do you want ReNative to create new Emulator ("+(0,_logger.chalk)().white(
...
'androidwear'?12:13;break;case 10:return _context14.abrupt("return",_createEmulator(c,'28','google_apis',emuName).then(function(){return launchAndroidSimulator(c,emuName,true);}));case 11:return _context14.abrupt("return",_createEmulator(c,'28','android-tv',emuName).then(function(){return launchAndroidSimulator(c,emuName,true);}));case 12:return _context14.abrupt("return",
_createEmulator(c,'28','android-wear',emuName).then(
function(){return launchAndroidSimulator(c,emuName,true);}));case 13:return _context14.abrupt("return",
...
var waitForEmulatorToBeReady=function waitForEmulatorToBeReady(c,emulator){return(0,_targetManager.waitForEmulator)(
c,
_constants.CLI_ANDROID_ADB,"-s "+
...
var checkForActiveEmulator=function checkForActiveEmulator(c){return new Promise(function(resolve,reject){
(0,_logger.logTask)('checkForActiveEmulator');var
platform=c.platform;
var attempts=1;
