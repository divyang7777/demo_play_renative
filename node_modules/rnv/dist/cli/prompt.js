...
if(msg&&params.logMessage)(0,_logger.logTask)(msg,(0,_logger.chalk)().grey);
...
var pressAnyKeyToContinue=function pressAnyKeyToContinue(){
var params={
type:'input',
name:'confirm',
message:'Press any key to continue'};

return _inquirer.default.prompt(params);
...
var _generateOptionString=function _generateOptionString(i,obj,mapping,defaultVal){return" ["+(0,_logger.chalk)().bold.grey(i+1)+"]> "+(0,_logger.chalk)().bold.grey(mapping?'':defaultVal)+" \n";};
