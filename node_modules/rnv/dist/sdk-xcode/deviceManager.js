...
c,
ignoreDevices,
ignoreSimulators){var platform,skipTargetCheck,devicesAndSims,simctl,availableSims,devicesArr,simulatorsArr,allDevices;return _regenerator.default.async(function getAppleDevices$(_context){while(1){switch(_context.prev=_context.next){case 0:

platform=c.platform;

(0,_logger.logTask)('getAppleDevices',"ignoreDevices:"+ignoreDevices+" ignoreSimulators"+ignoreSimulators);


skipTargetCheck=
c.program.skipTargetCheck;_context.next=5;return _regenerator.default.awrap(




(0,_exec.executeAsync)('xcrun instruments -s'));case 5:devicesAndSims=_context.sent;_context.t0=
JSON;_context.next=9;return _regenerator.default.awrap((0,_exec.executeAsync)('xcrun simctl list --json'));case 9:_context.t1=_context.sent;simctl=_context.t0.parse.call(_context.t0,_context.t1);
availableSims=[];
...
allDevices);case 18:case"end":return _context.stop();}}},null,null,null,Promise);};exports.getAppleDevices=getAppleDevices;
...
var launchAppleSimulator=function launchAppleSimulator(c,target){var devicesArr,selectedDevice,i,devices,_await$inquirer$promp,sim;return _regenerator.default.async(function launchAppleSimulator$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:
(0,_logger.logTask)('launchAppleSimulator',""+target);_context2.next=3;return _regenerator.default.awrap(

getAppleDevices(c,true));case 3:devicesArr=_context2.sent;
...
(0,_logger.chalk)().white(target)+" doesn't exists");
...
var listAppleDevices=function listAppleDevices(c){var platform,devicesArr,devicesString;return _regenerator.default.async(function listAppleDevices$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:
(0,_logger.logTask)('listAppleDevices');
platform=c.platform;_context3.next=4;return _regenerator.default.awrap(
getAppleDevices(c));case 4:devicesArr=_context3.sent;
devicesString='';
devicesArr.forEach(function(v,i){
devicesString+=" ["+(i+1)+"]> "+(0,_logger.chalk)().bold(v.name)+" | "+
v.icon+" | v: "+
(0,_logger.chalk)().green(v.version)+" | udid: "+(0,_logger.chalk)().grey(v.udid)+(
v.isDevice?(0,_logger.chalk)().red(' (device)'):'')+"\n";

});

(0,_logger.logToSummary)(platform+" Targets:\n\n"+devicesString);case 8:case"end":return _context3.stop();}}},null,null,null,Promise);};exports.listAppleDevices=listAppleDevices;
