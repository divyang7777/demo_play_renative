...
ip=arguments.length>5&&arguments[5]!==undefined?arguments[5]:'localhost';return(
new Promise(function(resolve){var _c$runtime;
var newPort=(_c$runtime=c.runtime)==null?void 0:_c$runtime.port;
(0,_logger.logTask)('parseAppDelegateSync',"ip:"+ip+" port:"+newPort);
...
(0,_logger.logDebug)('appDelegateImports add');
if(
c.pluginConfigiOS.pluginAppDelegateImports.indexOf(
appDelegateImport)===
-1)
{
(0,_logger.logDebug)('appDelegateImports add ok');
...
if(!plugArr){
(0,_logger.logWarning)("appDelegateMethods."+delKey+"."+(0,_logger.chalk)().red(key2)+" not supported. SKIPPING.");
}else{
