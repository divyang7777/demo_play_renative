var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:true});exports.injectPluginXmlValuesSync=exports.parseValuesColorsSync=exports.parseValuesStringsSync=void 0;
...
strings+="  <string name=\"app_name\">"+(0,_common.getAppTitle)(
c,
c.platform)+"</string>\n";
...
(0,_common.getBuildFilePath)(c,c.platform,stringsPath),
_path.default.join(appFolder,stringsPath),
[
{
pattern:'{{PLUGIN_COLORS_BG}}',
override:(0,_common.sanitizeColor)(
(0,_common.getConfigProp)(c,c.platform,'backgroundColor'),
'backgroundColor').
hex}],
...
var injectPluginXmlValuesSync=function injectPluginXmlValuesSync(c,plugin){var _plugin$ResourceStrin;
