...
result=SDK_LOACTIONS[sdkPlatform].find(function(v){return _fs.default.existsSync(v);});if(!
result){_context5.next=25;break;}
(0,_logger.logSuccess)("Found existing "+
c.platform+" SDK location at "+_chalk.default.white(
result));
...
setupInstance=(0,_setupTools.default)(c);_context5.next=29;return _regenerator.default.awrap(
...
_chalk.default.white(_getCurrentSdkPath(c)));_context6.t0=
