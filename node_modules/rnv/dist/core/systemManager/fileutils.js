...
var doResolve;
var isSystemWin;
var configureFilesystem=function configureFilesystem(_getConfigProp,_doResolve,_isSystemWin){
getConfigProp=_getConfigProp;
doResolve=_doResolve;
isSystemWin=_isSystemWin;
};exports.configureFilesystem=configureFilesystem;
...
var fsExistsSync=function fsExistsSync(dest){return _fs.default.existsSync(dest);};exports.fsExistsSync=fsExistsSync;

var fsReaddirSync=function fsReaddirSync(dest){return _fs.default.readdirSync(dest);};exports.fsReaddirSync=fsReaddirSync;

var fsLstatSync=function fsLstatSync(dest){return _fs.default.lstatSync(dest);};exports.fsLstatSync=fsLstatSync;

var fsReadFileSync=function fsReadFileSync(dest){return _fs.default.readFileSync(dest);};exports.fsReadFileSync=fsReadFileSync;

var fsChmodSync=function fsChmodSync(dest,flag){return _fs.default.chmodSync(dest,flag);};exports.fsChmodSync=fsChmodSync;

var fsRenameSync=function fsRenameSync(arg1,arg2){return _fs.default.renameSync(arg1,arg2);};exports.fsRenameSync=fsRenameSync;

var fsStatSync=function fsStatSync(arg1){return _fs.default.statSync(arg1);};exports.fsStatSync=fsStatSync;

var fsMkdirSync=function fsMkdirSync(arg1){return _fs.default.mkdirSync(arg1);};exports.fsMkdirSync=fsMkdirSync;

var fsUnlinkSync=function fsUnlinkSync(arg1){return _fs.default.unlinkSync(arg1);};exports.fsUnlinkSync=fsUnlinkSync;

var fsSymlinkSync=function fsSymlinkSync(arg1,arg2){
_fs.default.symlinkSync(arg1,arg2);
};exports.fsSymlinkSync=fsSymlinkSync;

var fsReadFile=function fsReadFile(arg1,arg2){
_fs.default.readFile(arg1,arg2);
};exports.fsReadFile=fsReadFile;

var fsReaddir=function fsReaddir(arg1,arg2){return _fs.default.readdir(arg1,arg2);};exports.fsReaddir=fsReaddir;
...
var configVal=getConfigProp(c,c.platform,val,'');
...
var writeFileSync=function writeFileSync(filePath,obj){var _output;var spaces=arguments.length>2&&arguments[2]!==undefined?arguments[2]:4;var addNewLine=arguments.length>3&&arguments[3]!==undefined?arguments[3]:true;
...
(0,_logger.logDebug)('writeFileSync',filePath,'executed',"size:"+((_output=output)==null?void 0:_output.length));
...
if(!p){
if(original){
(0,_logger.logDebug)("Path "+
(0,_logger.chalk)().white(
key)+" is not defined. using default: "+
(0,_logger.chalk)().white(original));
...
(0,_logger.logWarning)("_refToValue: "+(0,_logger.chalk)().white(realPath)+" does not exist!");
}
}
return ref;
};
